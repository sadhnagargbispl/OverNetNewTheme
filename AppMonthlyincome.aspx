<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AppMonthlyincome.aspx.cs" Inherits="AppMonthlyincome" %>
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li><a href="#">Monthly Payout Detail</a><span class="divider-last">&nbsp;</span></li>
                        </ul>
                    </div>
                </div>
                <div>
                                ...
                                <div class="row">
                                    <div class="widget">
                                        <div class="widget-title">
                                            <h4><i class="icon-credit-card"></i>MONTHLY PAYOUT DETAIL</h4>
                                            <span class="tools">
                                                                ...
                                                                <asp:Repeater ID="RptDirects" runat="server">
                                                                    <ItemTemplate>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <a href="AppMonthlyStatement.aspx?PayoutNo=<%# Eval("Sessid") %>" target="_blank" style="color: Blue">Statement</a>
                                                                            </td>
                                                                        </tr>
                                                                    </ItemTemplate>
                                                                </asp:Repeater>
