...
public partial class AppChangePass : System.Web.UI.Page
{
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (tmptbl.Rows.Count == 1)
                        {
                            ...
                            if (i != 0)
                            {
                                Response.Write("<script language='javascript'>window.alert('Password Changed Successfully, Login Again!!');</script>");
                            }
                        }
                        else
                        {
