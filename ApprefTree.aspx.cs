...
public partial class ApprefTree : System.Web.UI.Page
{
    string strQuery;
    int minDeptLevel;
    ...
    private void GenerateTree(string strQuery)
    {
        ...
        {
            DataSet ds1 = new DataSet();
            string s = Objdal.Isostart + strQuery + Objdal.IsoEnd;
            ds1 = SqlHelper.ExecuteDataset(constr1, CommandType.Text, s);
            string ParentId;
            double FormNo;
            string MemberName = "";
            string LegNo;
            ...
            tmpDS = SqlHelper.ExecuteDataset(constr1, CommandType.Text, Objdal.Isostart + " Exec sp_TreeDetail '" + FormNo + "' " + Objdal.IsoEnd);
            ...
            foreach (DataRow dr in ds1.Tables[0].Rows)
            {
                ...
                strUrlPath = "ApprefTree.aspx?DownLineFormNo=" + FormNo + "";
