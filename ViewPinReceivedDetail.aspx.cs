...
public partial class ViewPinReceivedDetail : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                {
                    if (!string.IsNullOrEmpty(Request["TransNo"]))
                    {
                        BindData();
                    }
                }
    ...
    public void BindData(string SrchCond = "")
    {
        try
        {
            ...
            string cond = "";
            string formno = "";
            string sql1 = objDAL.Isostart + "Exec sp_GetEpinViewReceveiedDetail '" + Session["formno"] + "','" + Request["TransNo"] + "' " + objDAL.IsoEnd;
