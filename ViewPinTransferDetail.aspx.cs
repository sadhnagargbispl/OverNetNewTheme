...
public partial class ViewPinTransferDetail : System.Web.UI.Page
{
    ...
    public void BindData(string SrchCond = "")
    {
        try
        {
            ...
            string cond = "";
            string formno = "";
            string sql1 = objDAL.Isostart + "Exec sp_GetEpinTransferDetail '" + Session["formno"] + "','" + Request["TransNo"] + "' " + objDAL.IsoEnd;
