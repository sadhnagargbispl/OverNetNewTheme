<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewPinReceivedDetail.aspx.cs" Inherits="ViewPinReceivedDetail" %>
        ...
        <div style="margin-bottom: 10px; padding-right: 20px; padding-left: 20px; padding-top: 20px">
            <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="FRomIdno" HeaderText="Transfer From IE"></asp:BoundField>
                    <asp:BoundField DataField="FromMemname" HeaderText="Transfer From Entrepreneur"></asp:BoundField>
                    ...
                    <asp:BoundField DataField="ToDate" HeaderText="Date"></asp:BoundField>
