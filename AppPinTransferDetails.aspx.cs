...
public partial class AppPinTransferDetails : System.Web.UI.Page
{
    DataSet Ds;
    ...
    private void FillKit()
    {
        try
        {
            ...
            string sql = Objdal.Isostart + "Select KitID,KitName From (Select 0 As KitID,'-- ALL --' As KitName Union Select KitID,KitName+' ('+cast(KitAmount As Varchar)+')'  as KitName From " + ObjDal.dBName + "..M_KitMaster Where ActiveStatus='Y' and RowStatus='Y' and OnWebsite='Y') as temp Order By Kitid " + Objdal.IsoEnd;
    ...
    private void GetEpinDetails(int pageIndex)
    {
        try
        {
            ...
            str = ObjDal.Isostart + " exec Sp_GetTotalSendPin '" + Session["FormNo"] + "','" + CmbKit.SelectedValue + "' " + ObjDal.IsoEnd;
