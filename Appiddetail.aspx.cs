...
using System.Linq;
public partial class Appiddetail : System.Web.UI.Page
{
    double dblBank;
    ...
    private void LoadImages()
    {
        try
        {
            ...
            str = ObjDal.Isostart + "SELECT a.IDNo, a.MemFirstName AS MemName, a.Address1, a.City, a.Tehsil, a.District, AreaCode, " +
