...
public partial class AppPingenerateDetail : System.Web.UI.Page
{
    ...
    private void Fill_Grid()
    {
        try
        {
            ...
            str = Objdal.Isostart + " exec Sp_GetTotalGeneratePin '" + Session["FormNo"] + "' " + Objdal.IsoEnd;
            dt = SqlHelper.ExecuteDataset(constr1, CommandType.Text, str).Tables[0];
            Session["GeneratePinReport"] = dt;
            if (dt.Rows.Count > 0)
            {
