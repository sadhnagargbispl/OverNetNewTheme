<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="AppDownline.aspx.cs" Inherits="AppDownline" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <Triggers>
                                ...
                                <div id="DivSideB" runat="server" class="wallet-table-wrapper">
    ...
    <ContentTemplate>--%>
                                        <table id="customers3" class="table table-bordered table-stripeds">
                                            <thead>
                                                <tr>
                                                    <th>SNo
                                                    </th>
